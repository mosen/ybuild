...
var path      = require('path'),
    default_spec = require('./default_spec.js');
...
Component.prototype._getDetailString = function(detail) {
    if (this._buildSpec.details &&
        this._buildSpec.details.hasOwnProperty(detail) &&
...
var ATTRS = {
    ...
    skinnable : {
        get : function() {
            if (this._buildSpec.hasOwnProperty('details') &&
                this._buildSpec.details.skinnable) {
                return true;
            } else {
                return false;
            }
    ...
    sourcefiles : {
        get : function() {
            ...
            if (this._buildSpec.hasOwnProperty('sourceFiles') && this._buildSpec.sourceFiles.length > 0) {
    ...
    details : {
        get : function() {
            ...
            if (this._buildSpec.details &&
                this._buildSpec.details.skinnable === true) {
